...
function processRows(json) {
    json.forEach((row) => {
        ...
        apps.innerHTML = "<a class='application_link' href='hackerindia.in/Mods/file.html?id="+row.package_name+"'><img class='' src='"+row.package_icon+"' alt='' /><p class='application_name'>"+row.package_name+"</p><p class='mod_info'>MOD, "+row.package_mod_info+"</p><p class='application_rating'>"+row.package_rating+"</p></a>";
        games.innerHTML = "<a class='application_link' href='hackerindia.in/Mods/file.html?id="+row.package_name+"'><img class='' src='"+row.package_icon+"' alt='' /><p class='application_name'>"+row.package_name+"</p><p class='mod_info'>MOD, "+row.package_mod_info+"</p><p class='application_rating'>"+row.package_rating+"</p></a>";
        applicationContainer.innerHTML = "<a class='application_link' href='hackerindia.in/Mods/file.html?id="+row.package_name+"'><img class='' src='"+row.package_icon+"' alt='' /><p class='application_name'>"+row.package_name+"</p><p class='mod_info'>MOD, "+row.package_mod_info+"</p><p class='application_rating'>"+row.package_rating+"</p></a>";
